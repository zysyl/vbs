'=====================================================================
' NAME:		ComputersByOperatingSystem.vbs
'
...
Const SQL_STATEMENT = "SELECT objectGuid, cn, operatingSystem, operatingSystemVersion, createTimeStamp, lastLogonTimestamp FROM 'LDAP://DC=Sbet-EMEA,DC=ADS' WHERE objectCategory='computer' AND objectClass='user' ORDER BY cn"					  
...
Call WriteToLog (glb_Logfilename, "Account GUID" &vbTab& "Hostname" &vbTab& "OS" &vbTab& "OS Version" &vbTab& "Created" &vbTab& "Last Logon")
...
Do Until glb_objADRecordset.EOF
	...
	Call WriteToLog (glb_Logfilename, BytesToHexString( glb_objADRecordset.Fields("objectGUID") ) & vbTab & _
						glb_objADRecordset.Fields("cn") & vbTab & _
						 glb_objADRecordset.Fields("operatingSystem") & vbTab & _
						  glb_objADRecordset.Fields("operatingSystemVersion") & vbTab & _ 
